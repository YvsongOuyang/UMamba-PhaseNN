...
def main():
    ...
    parser.add_argument("--output-json", default="./umamba_based_autophasenn/output/evaluation_results.json")
    ...
    print(format_fixed_metric_groups(report["mean"], title="Evaluation mean metrics"))
