...
| Total evaluation wall time | 47.6089 s |
| Mean model inference | 6.34257 ms/sample |
| Model throughput | 157.665 samples/s |
...
| `real_amp_ssim` | 0.896557 | 0.026291 | 0.897817 | 0.937381 | higher | Fig. 2: local-window 3D SSIM of real-space amplitude. |
...
| Metric | Mean | Meaning |
|---|---:|---|
| `real_amp_l1` | 0.0194739 | Real-space full-volume amplitude L1. Lower is better, but can be small for sparse objects. |
| `real_amp_ssim` | 0.896557 | Local-window 3D amplitude SSIM reported by the paper. Higher is better. |
| `real_amp_global_ssim` | 0.462755 | Global 3D amplitude SSIM-like score. Higher is better. |
| `real_support_iou` | 0.301013 | Intersection-over-union between predicted and true support. Higher is better. |
| `real_support_dice` | 0.446584 | Dice score between predicted and true support. Higher is better. |
...
| `real_phase_mae_true_support` | 1.04631 | Wrapped phase MAE on the true support. Lower is better. |
...
| Metric | Mean | Meaning |
|---|---:|---|
| `real_amp_mse` | 0.0153509 | Real-space full-volume amplitude MSE. Lower is better. |
| `real_amp_rmse` | 0.121366 | Real-space full-volume amplitude RMSE. Lower is better. |
| `real_support_true_fraction` | 0.0234351 | True support fraction in the 64^3 volume. |
| `real_phase_mae_intersection` | 0.638636 | Wrapped phase MAE on support intersection. Lower is better. |
| `real_phase_rmse_true_support` | 1.30045 | Wrapped phase RMSE on the true support. Lower is better. |
...
| Metric | Mean | Meaning |
|---|---:|---|
| `inference_ms` | 6.34257 | Additional evaluation diagnostic. |
| `real_amp_rel_l1` | 1.1398 | Real-space amplitude L1 normalized by true amplitude sum. Lower is better. |
| `real_phase_l1_true_support` | 1.04631 | Wrapped phase L1 on the true support. Lower is better. |
| `real_phase_mse_true_support` | 1.79141 | Wrapped phase MSE on the true support. Lower is better. |
| `real_phase_rel_l1_true_support` | 1.63766 | Wrapped phase L1 normalized by target phase magnitude on the true support. Lower is better. |
| `real_support_l1` | 0.024117 | Binary support mask L1. Lower is better. |
| `real_support_mse` | 0.024117 | Binary support mask MSE. Lower is better. |
| `real_support_rel_l1` | 1.11479 | Binary support mask L1 normalized by true support volume. Lower is better. |
| `real_support_rmse` | 0.152781 | Binary support mask RMSE. Lower is better. |
