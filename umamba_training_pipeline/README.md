...
- The UMamba model structure is restored to the original decoder path: nearest-neighbor upsampling plus skip concatenation. It no longer applies center zero-padding, skip dropping, or a fixed centered output mask.
...
Current defaults are chosen for original-structure UMamba overfit testing:
