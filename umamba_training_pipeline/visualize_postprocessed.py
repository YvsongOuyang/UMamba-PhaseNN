...
def parse_args():
    ...
    parser.add_argument("--checkpoint", default="/data_ssd/oyys/autophasenn/Unsupfalse_Dfalse_Ufalse_T0.1_comb2_batch8_plateau_Init1e-3_adam_scale1/best_model.pt")
